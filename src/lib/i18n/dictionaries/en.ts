const en = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "How does payment work?", a: "Pay by card, PayPal, Apple Pay or Google Pay via LemonSqueezy for instant activation, or with USDT via Binance Pay. You'll be redirected to a secure hosted checkout." },
  ...
  checkout: {
    ...
    payWithCard: "Pay by card / PayPal",
    cardNote: "Instant activation. Cards, PayPal, Apple Pay and Google Pay via LemonSqueezy.",
    orDivider: "or",
    cardUnavailable: "Card payments aren't set up yet — please use the crypto option below.",
    cardError: "Couldn't open the checkout. Please try again.",
  },
  notFound: {
